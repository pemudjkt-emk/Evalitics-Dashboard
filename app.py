...
# Menghapus CSS tab lama, merapikan area Uploader, dan UI/UX UPGRADE Menu Kapsul (Pill)
st.markdown("""
    ...
    /* ====================================================
       UI/UX UPGRADE: Sidebar "Pill-Shaped" Menu Concept
       ==================================================== */
    
    /* Background Sidebar menjadi Abu-abu Muda */
    ...
    /* Sembunyikan icon lingkaran bawaan radio button secara paksa (Robust Selector) */
    [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label > div:first-child {
        display: none !important;
    }
    
    /* Desain Default Menu (Transparan/Pill) */
    [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label {
        background-color: transparent; 
        border-radius: 30px; /* Bentuk Kapsul identik dengan tombol Sinkron */
        padding: 12px 18px;
        cursor: pointer;
    ...
    /* Hover effect menu pasif */
    [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label:hover {
        background-color: #e2e8f0;
        transform: translateY(-1px);
    }
    
    /* Desain Menu AKTIF (Teal/Cyan Gradient Kapsul Penuh) */
    [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked) {
        background: linear-gradient(90deg, #17a2b8 0%, #20c997 100%); 
        box-shadow: 0px 4px 12px rgba(23, 162, 184, 0.3);
        border-radius: 30px; /* Bentuk Kapsul/Pill */
    }
    ...
    /* Desain Tombol "Sinkron Data Terkini" */
    [data-testid="stSidebar"] button[kind="secondary"] {
        background: linear-gradient(90deg, #17a2b8 0%, #20c997 100%);
        color: white !important;
        border: none;
        border-radius: 30px; /* Bentuk kapsul penuh */
        padding: 12px;
        font-weight: bold;
        box-shadow: 0px 4px 12px rgba(23, 162, 184, 0.3);
